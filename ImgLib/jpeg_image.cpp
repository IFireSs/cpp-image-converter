    ...
    */
     ...
     */
        ...
        for (int i = 0; i < image.GetWidth(); ++i) {
            buff[i * 3 + 0] = static_cast<JSAMPLE>(image.GetLine(cinfo.next_scanline)[i].r);
            buff[i * 3 + 1] = static_cast<JSAMPLE>(image.GetLine(cinfo.next_scanline)[i].g);
            buff[i * 3 + 2] = static_cast<JSAMPLE>(image.GetLine(cinfo.next_scanline)[i].b);
        }
